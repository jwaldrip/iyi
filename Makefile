...
# beside `bin/iyi` is 122 KB rather than a standard library.
.PHONY: install_iyi
...
# ships only iyi's own 122 KB answers `require "json"` with "can't find file",
...
# Its prelude is its own, and it is 122 KB: `iyi` installed as `bin/iyi` finds
