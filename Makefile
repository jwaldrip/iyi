...
# beside `bin/iyi` is 466 KB rather than a standard library.
.PHONY: install_iyi
...
# ships only iyi's own 466 KB answers `require "json"` with "can't find file",
...
# Its prelude is its own, and it is 466 KB: `iyi` installed as `bin/iyi` finds
