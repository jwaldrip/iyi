...
# beside `bin/iyi` is 633 KB rather than a standard library.
.PHONY: install_iyi
...
# ships only iyi's own 633 KB answers `require "json"` with "can't find file",
...
# Its prelude is its own, and it is 633 KB: `iyi` installed as `bin/iyi` finds
