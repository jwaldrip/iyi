...
# beside `bin/iyi` is 430 KB rather than a standard library.
.PHONY: install_iyi
...
# ships only iyi's own 430 KB answers `require "json"` with "can't find file",
...
# Its prelude is its own, and it is 430 KB: `iyi` installed as `bin/iyi` finds
