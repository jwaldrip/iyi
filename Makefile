...
# beside `bin/iyi` is 452 KB rather than a standard library.
.PHONY: install_iyi
...
# ships only iyi's own 452 KB answers `require "json"` with "can't find file",
...
# Its prelude is its own, and it is 452 KB: `iyi` installed as `bin/iyi` finds
