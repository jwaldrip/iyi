...
it uses, and iyi's own library is 3,641 lines rather than 8,161. The whole
...
program *has*: 8,161 lines of Crystal's standard library instead of 3,641
...
- **iyi's own library is 3,641 lines, and its IO is `puts`, `print`,
...
| [`src/iyi`](src/iyi) | iyi's own library, 3,641 lines. `--crystal` swaps it for Crystal's |
