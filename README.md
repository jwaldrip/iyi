...
it uses, and iyi's own library is 13,600 lines rather than 8,161. The whole
...
program *has*: 8,161 lines of Crystal's standard library instead of 13,600
...
- **iyi's own library is 13,600 lines, and its IO is `puts`, `print`,
...
| [`src/iyi`](src/iyi) | iyi's own library, 13,600 lines. `--crystal` swaps it for Crystal's |
