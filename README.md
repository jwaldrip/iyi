...
program *has*: 8,161 lines of Crystal's standard library instead of 11,202
...
- **iyi's own library is 11,202 lines, and its IO is `puts`, `print`,
...
| [`src/iyi`](src/iyi) | iyi's own library, 11,202 lines. `--crystal` swaps it for Crystal's |
