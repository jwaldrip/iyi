...
it uses, and iyi's own library is 15,773 lines rather than 8,161. The whole
...
iyi's own 621 KB prelude, the 1,269 KB of `src/std` that `import std/...`
...
program *has*: 8,161 lines of Crystal's standard library instead of 15,773
...
- **iyi's own library is 15,773 lines, and its IO is `puts`, `print`, the
...
| [`src/iyi`](src/iyi) | iyi's own library, 15,773 lines. `--crystal` swaps it for Crystal's |
