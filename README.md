...
it uses, and iyi's own library is 15,765 lines rather than 8,161. The whole
...
program *has*: 8,161 lines of Crystal's standard library instead of 15,765
...
- **iyi's own library is 15,765 lines, and its IO is `puts`, `print`, the
...
| [`src/iyi`](src/iyi) | iyi's own library, 15,765 lines. `--crystal` swaps it for Crystal's |
