...
it uses, and iyi's own library is 3,443 lines rather than 8,161. The whole
library is 115 KB on disk beside the binary.
...
The tarball is relocatable and carries both libraries: iyi's own 115 KB, and
...
program *has*: 8,161 lines of Crystal's standard library instead of 3,443
...
- **iyi's own library is 3,443 lines, and its IO is `puts`, `print`,
...
| [`src/iyi`](src/iyi) | iyi's own library, 3,443 lines. `--crystal` swaps it for Crystal's |
