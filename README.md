...
it uses, and iyi's own library is 3,644 lines rather than 8,161. The whole
library is 121 KB on disk beside the binary.
...
program *has*: 8,161 lines of Crystal's standard library instead of 3,644
...
- **iyi's own library is 3,644 lines, and its IO is `puts`, `print`,
...
| [`src/iyi`](src/iyi) | iyi's own library, 3,644 lines. `--crystal` swaps it for Crystal's |
