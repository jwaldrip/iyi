...
it uses, and iyi's own library is 11,745 lines rather than 8,161. The whole
library is 465 KB on disk beside the binary.
...
The tarball is relocatable and carries both libraries: iyi's own 465 KB, and
...
program *has*: 8,161 lines of Crystal's standard library instead of 11,745
...
- **iyi's own library is 11,745 lines, and its IO is `puts`, `print`,
