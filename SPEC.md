...
| iyi's own prelude | 14,389 lines, of which 4,632 are the library held to the 3,734 ceiling; the rest is the collector, the scheduler and the float printer, which 0.1.0's prelude got from libgc, pthreads and libc |
...
> "No standard library worth the name" is still true of iyi's own 14,389 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 14,389 lines,
primitives included, of which the library is 4,632.** Not a standard library:
...
**4,632 lines** of the 13,581, measured by `bench/doc_numbers.py` as
...
has carried it to 4,632, 898 lines over. Each module was
...
| Library | 8,161 lines (3,551 of it core) | 14,389-line own prelude + 778 in samples |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 14,389-line prelude.
