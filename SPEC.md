...
| iyi's own prelude | 11,773 lines, of which 2,814 are the library held to the 3,734 ceiling; the rest is the collector, the scheduler and the float printer, which 0.1.0's prelude got from libgc, pthreads and libc |
...
> "No standard library worth the name" is still true of iyi's own 11,773 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 11,773 lines,
primitives included, of which the library is 2,814.** Not a standard library:
...
**2,814 lines** of the 11,773, measured by `bench/doc_numbers.py` as
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 104,096 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 11,773-line own prelude + 778 in samples |
...
12e. **The library as an artifact. A measurement, not a plan.** IV.1d ends with
    ...
    **The prize.** A generated module the shape of a library — 103,002 lines,
    ...
    195,833 lines and about 11,773 of them are a `def` or a type header.
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 11,773-line prelude.
