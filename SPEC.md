...
| iyi's own prelude | 13,841 lines, of which 3,626 are the library held to the 3,734 ceiling; the rest is the collector, the scheduler and the float printer, which 0.1.0's prelude got from libgc, pthreads and libc |
...
> "No standard library worth the name" is still true of iyi's own 13,841 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 13,841 lines,
...
| Library | 8,161 lines (3,551 of it core) | 13,841-line own prelude + 5,997 in std |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 13,841-line prelude.
