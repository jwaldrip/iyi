...
| iyi's own prelude | 11,341 lines, ceiling 3,734 |
...
> "No standard library worth the name" is still true of iyi's own 11,341 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 11,341 lines,
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 103,899 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 11,341-line own prelude + 778 in samples |
...
12e. **The library as an artifact. A measurement, not a plan.** IV.1d ends with
    ...
    **The prize.** A generated module the shape of a library — 103,002 lines,
    ...
    195,833 lines and about 11,341 of them are a `def` or a type header.
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 11,341-line prelude.
