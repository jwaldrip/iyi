...
| iyi's own prelude | 13,568 lines, of which 4,609 are the library held to the 3,734 ceiling; the rest is the collector, the scheduler and the float printer, which 0.1.0's prelude got from libgc, pthreads and libc |
...
> "No standard library worth the name" is still true of iyi's own 13,568 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 13,568 lines,
primitives included, of which the library is 4,609.** Not a standard library:
...
**4,609 lines** of the 13,568, measured by `bench/doc_numbers.py` as
...
written, and those three carry it to 4,609, which is 875 lines over. Each was
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 106,310 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 13,568-line own prelude + 778 in samples |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 13,568-line prelude.
