...
| iyi's own prelude | 2,872 lines, ceiling 3,551 |
...
> "No standard library worth the name" is still true of iyi's own 2,872 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 2,872 lines,
...
| Library | 8,161 lines (3,551 of it core) | 2,872-line own prelude + 777 in samples |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 2,872-line prelude.
