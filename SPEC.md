...
| iyi's own prelude | 13,948 lines, of which 3,733 are the library held to the 3,734 ceiling; the rest is the collector, the scheduler and the float printer, which 0.1.0's prelude got from libgc, pthreads and libc |
...
| Library | 8,161 lines (3,551 of it core) | 13,948-line own prelude + 6,037 in std |
