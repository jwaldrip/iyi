...
| iyi's own prelude | 10,139 lines, ceiling 3,734 |
...
> "No standard library worth the name" is still true of iyi's own 10,139 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 10,139 lines,
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 103,498 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 10,139-line own prelude + 778 in samples |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 10,139-line prelude.
