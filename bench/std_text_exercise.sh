...
prove_fails_prelude "base parsing broken" no_base "string: to_i base 16" \
...
prove_fails_prelude "string split broken" no_split "string: split str" \
  's/byte_slice(start, found - start)/"broken"/'
