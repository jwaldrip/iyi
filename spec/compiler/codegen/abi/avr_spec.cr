      ...
      describe "abi_info" do
        {% for bits in [1, 8, 16, 32, 64] %}
          test "int{{bits}}" do |abi, ctx|
            ...
            info.arg_types[0].kind.should eq(Iyi::ABI::ArgKind::Direct)
            info.return_type.should eq(arg_type)
            info.return_type.kind.should eq(Iyi::ABI::ArgKind::Direct)
          end
        {% end %}
        ...
        test "multiple arguments" do |abi, ctx|
          ...
          info.arg_types.each(&.kind.should eq(Iyi::ABI::ArgKind::Direct))
        end
        ...
        test "multiple arguments above registers" do |abi, ctx|
          ...
          info.arg_types[0].kind.should eq(Iyi::ABI::ArgKind::Direct)
          info.arg_types[1].kind.should eq(Iyi::ABI::ArgKind::Direct)
          info.arg_types[2].kind.should eq(Iyi::ABI::ArgKind::Direct)
          info.arg_types[3].kind.should eq(Iyi::ABI::ArgKind::Direct)
          info.arg_types[4].kind.should eq(Iyi::ABI::ArgKind::Indirect)
        end
        ...
        test "struct args over 18 bytes" do |abi, ctx|
          ...
          info.arg_types[0].kind.should eq(Iyi::ABI::ArgKind::Direct)
          info.arg_types[1].kind.should eq(Iyi::ABI::ArgKind::Direct)
          info.arg_types[2].kind.should eq(Iyi::ABI::ArgKind::Indirect)
        end
        ...
        test "returns struct over 8 bytes" do |abi, ctx|
          ...
          info = abi.abi_info([] of LLVM::Type, rty, true, ctx)
          info.return_type.kind.should eq(Iyi::ABI::ArgKind::Indirect)
        end
      end
    {% end %}
  end
