...
describe "Normalize: array literal" do
  ...
  it "normalizes non-empty with of" do
    assert_expand "[1, 2] of Int8", <<-CODE
  ...
  it "normalizes non-empty with of, with splat" do
    assert_expand "[1, *2, *3, 4, 5] of Int8", <<-CODE
  ...
  it "hoists complex element expressions, array-like" do
    assert_expand_named "Foo{[1], *[2]}", <<-CODE
      __temp_1 = [1]
      __temp_2 = [2]
      __temp_3 = Foo.new
      __temp_3 << __temp_1
  ...
  it "hoists complex element expressions, array-like generic" do
    assert_expand_named "Foo{[1], *[2]}", <<-CODE, generic: "Foo"
      __temp_1 = [1]
      __temp_2 = [2]
  ...
  it "normalizes with filename" do
    assert_expand_named "Foo{x, *y}", <<-CODE, filename: "foo.cr"
      __temp_1 = x
      __temp_2 = y
      __temp_3 = Foo.new
      __temp_3 << __temp_1
    ...
    assert_expand_named "Foo{x, *y}", <<-CODE, filename: "bar.cr"
      __temp_1 = x
      __temp_2 = y
      __temp_3 = Foo.new
      __temp_3 << __temp_1
