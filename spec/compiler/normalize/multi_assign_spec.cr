...
describe "Normalize: multi assign" do
  it "normalizes n to n" do
    assert_expand "a, b, c = 1, 2, 3", <<-CODE
      __temp_1 = 1
      __temp_2 = 2
      __temp_3 = 3
      a = __temp_1
  ...
  it "normalizes n to n with []" do
    assert_expand "a = 1; b = 2; a[0], b[1] = 2, 3", <<-CODE
      __temp_1 = 2
      __temp_2 = 3
      a[0] = __temp_1
      b[1] = __temp_2
  ...
  it "normalizes n to n with call" do
    assert_expand "a = 1; b = 2; a.foo, b.bar = 2, 3", <<-CODE
      __temp_1 = 2
      __temp_2 = 3
      a.foo = __temp_1
      b.bar = __temp_2
  ...
  context "without strict_multi_assign" do
    it "normalizes 1 to n" do
      assert_expand "d = 1; a, b, c = d", <<-CODE
        __temp_1 = d
        a = __temp_1[0]
        b = __temp_1[1]
        c = __temp_1[2]
    ...
    it "normalizes 1 to n with []" do
      assert_expand "a = 1; b = 2; a[0], b[1] = 2", <<-CODE
        __temp_1 = 2
        a[0] = __temp_1[0]
        b[1] = __temp_1[1]
        CODE
    ...
    it "normalizes 1 to n with call" do
      assert_expand "a = 1; b = 2; a.foo, b.bar = 2", <<-CODE
        __temp_1 = 2
        a.foo = __temp_1[0]
        b.bar = __temp_1[1]
        CODE
  ...
  context "strict_multi_assign" do
    it "normalizes 1 to n" do
      assert_expand "d = 1; a, b, c = d", <<-CODE, flags: "strict_multi_assign"
        __temp_1 = d
        if __temp_1.size != 3
    ...
    it "normalizes 1 to n with []" do
      assert_expand "a = 1; b = 2; a[0], b[1] = 2", <<-CODE, flags: "strict_multi_assign"
        __temp_1 = 2
        if __temp_1.size != 2
          ::raise(::IndexError.new("Multiple assignment count mismatch"))
        end
    ...
    it "normalizes 1 to n with call" do
      assert_expand "a = 1; b = 2; a.foo, b.bar = 2", <<-CODE, flags: "strict_multi_assign"
        __temp_1 = 2
        if __temp_1.size != 2
          ::raise(::IndexError.new("Multiple assignment count mismatch"))
        end
  ...
  it "normalizes m to n, with splat on left-hand side, splat is empty" do
    assert_expand "a = 1; b = 2; *a[0], b.foo, c = 3, 4", <<-CODE
      __temp_1 = ::Tuple.new
      __temp_2 = 3
      __temp_3 = 4
      a[0] = __temp_1
  ...
  it "normalizes m to n, with *_ on left-hand side (1)" do
    assert_expand "a, *_, b, c = 1, 2, 3, 4, 5", <<-CODE
      __temp_1 = 1
      2
      3
      __temp_2 = 4
  ...
  it "normalizes m to n, with *_ on left-hand side (2)" do
    assert_expand "*_, a, b, c = 1, 2, 3, 4, 5", <<-CODE
      1
      2
      __temp_1 = 3
      __temp_2 = 4
  ...
  it "normalizes m to n, with *_ on left-hand side (3)" do
    assert_expand "a, b, c, *_ = 1, 2, 3, 4, 5", <<-CODE
      __temp_1 = 1
      __temp_2 = 2
      __temp_3 = 3
      4
  ...
  it "normalizes 1 to n, with splat on left-hand side" do
    assert_expand "c = 1; d = 2; a, b, *c.foo, d[0], e, f = 3", <<-CODE
      __temp_1 = 3
      if __temp_1.size < 5
        ::raise(::IndexError.new("Multiple assignment count mismatch"))
      end
